Ext.define('ext.view.common.popup.StudentPopup', {
...
//				},
				{xtype: 'metext', fieldLabel: 'Student Name',name:'memberName', cls: 'col-xs-10 item form-controls', width : '100%', labelWidth : 110,
					listeners:  {
...
//			        },
		...
		var mainStore = Ext.create('component.meStore',{
			...
			proxy : {
	   	 		type : 'ajax',
	   	 		url : CONTEXT_PATH + '/general/getListStudent.json',	   	 		
	   	 		reader : {
	   	 			type : 'json',
	   	 			enablePaging : true,
